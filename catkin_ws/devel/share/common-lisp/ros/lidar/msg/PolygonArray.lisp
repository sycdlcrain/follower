...
(cl:defmethod cl:initialize-instance :after ((m <PolygonArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PolygonArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<PolygonArray> is deprecated: use lidar-msg:PolygonArray instead.")))
...
(cl:defmethod polygons-val ((m <PolygonArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:polygons-val is deprecated.  Use lidar-msg:polygons instead.")
  (polygons m))

(cl:ensure-generic-function 'labels-val :lambda-list '(m))
(cl:defmethod labels-val ((m <PolygonArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:labels-val is deprecated.  Use lidar-msg:labels instead.")
  (labels m))

(cl:ensure-generic-function 'likelihood-val :lambda-list '(m))
(cl:defmethod likelihood-val ((m <PolygonArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:likelihood-val is deprecated.  Use lidar-msg:likelihood instead.")
  (likelihood m))
